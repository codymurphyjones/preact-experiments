...
export declare const enum OptionsTypes {
    HOOK = "__h",
    DIFF = "__b",
    DIFFED = "diffed",
    RENDER = "__r",
...
export type HookFn<T extends keyof OptionsType> = (old: OptionsType[T], ...a: Parameters<OptionsType[T]>) => ReturnType<OptionsType[T]>;
